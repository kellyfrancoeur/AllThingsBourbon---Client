    ...
    return (
        <body>
            <main className="howToServe">
                <section>
                    <form>
                        <h2>How to Serve Bourbon</h2>
                        <section className="intro">
                            <p>
                            You can drink quality bourbon whiskey in lots of different ways. Indeed, it’s a versatile beverage that can play a variety of roles in your drinks cabinet from cocktails to neat sipping.
                            </p><p>
                            In this particular guide, you will learn everything you need to know about how to drink bourbon whiskey:
                            </p>
                            <p><a href="#rules">Rules for Drinking Bourbon</a></p>
                            <p><a href="#drink">How to Drink Bourbon</a></p>
                            <p><a href="#rocks">Bourbon On The Rocks</a></p>
                            <p><a href="#serve">How to Serve Bourbon</a></p>
                            <p>Use the links above to jump to a specific section or scroll down to read through all!</p>

                            <img src="https://media.istockphoto.com/id/1085322468/photo/pouring-whiskey-from-bottle-into-glass-with-ice.jpg?s=612x612&w=0&k=20&c=O5nPiD2D5FpNpD4Qai76Xga-itJwlNMKuMUnjeNa5_s=" height="350" width="300"></img>
                            <section id="rules">
                                <h3>Rules for Drinking Bourbon</h3>
                                <img src="https://glassandvine.com/wp-content/uploads/Decanter-of-whiskey-and-a-glass-with-cuban-cigar-on-a-wooden-table.jpg" height="350" width="300"></img>
                                ...
                                <p>Additionally, you should drink bourbon in a way that you enjoy it. Don’t feel that you have to conform to a “correct” way because it’s what you’ve been told. Like all alcoholic spirits, bourbon should be fun, relaxing, and above all, tasty.</p>
                                <p>Therefore, if you want to add ice, throw in as much as you want. You prefer it chilled? Don’t let people tell you that you can’t put it in the fridge. Slam it down or take your time. If you paid for it, it’s yours to do with how you please.</p>
                              </section>
                            <section id="drink">
                                <h3>How to Drink Bourbon</h3>
                                <img src="https://www.simplyrecipes.com/thmb/emBLFdFsdH2INtxf8hTEVzBpt6A=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/BestWhiskyGlasses_GroupShot_03-ea83b029dc1843279d41f9676ca26ca2.jpg" height="350" width="300"></img>
                            ...
                            <section id="rocks">
                                <h3>Bourbon On The Rocks</h3>
                                <img src="https://www.tastingtable.com/img/gallery/25-best-bourbon-cocktails-ranked/l-intro-1646935912.jpg" height="350" width="300"></img>
                            ...
                            <section id="serve">
                                <h3>How to Serve Bourbon</h3>
                                <img src="https://restaurantclicks.com/wp-content/uploads/2021/06/Bartender-Serving-Bourbon-Whiskey.jpg" height="350" width="300"></img>
